...
GRANT SELECT ON FUTURE TABLES IN DATABASE CB_STANDARD TO ROLE CB_ADMIN WITH GRANT OPTION;
GRANT SELECT ON FUTURE TABLES IN DATABASE CB_DEV TO ROLE CB_ADMIN WITH GRANT OPTION;
GRANT SELECT ON FUTURE TABLES IN DATABASE CB_CLIENT1 TO ROLE CB_ADMIN WITH GRANT OPTION;
GRANT SELECT ON FUTURE TABLES IN DATABASE CB_CLIENT2 TO ROLE CB_ADMIN WITH GRANT OPTION;

GRANT SELECT ON FUTURE VIEWS IN DATABASE CB_STANDARD TO ROLE CB_ADMIN WITH GRANT OPTION;
GRANT SELECT ON FUTURE VIEWS IN DATABASE CB_DEV TO ROLE CB_ADMIN WITH GRANT OPTION;
GRANT SELECT ON FUTURE VIEWS IN DATABASE CB_CLIENT1 TO ROLE CB_ADMIN WITH GRANT OPTION;
GRANT SELECT ON FUTURE VIEWS IN DATABASE CB_CLIENT2 TO ROLE CB_ADMIN WITH GRANT OPTION;
