...
GRANT SELECT ON ALL TABLES IN SCHEMA CB_DEV.STG TO ROLE CB_DEV;
GRANT SELECT ON ALL VIEWS IN SCHEMA CB_DEV.STG TO ROLE CB_DEV;
GRANT SELECT ON FUTURE VIEWS IN SCHEMA CB_DEV.STG TO ROLE CB_DEV;
GRANT SELECT ON FUTURE VIEWS IN SCHEMA CB_DEV.STG TO ROLE CB_DEV;
